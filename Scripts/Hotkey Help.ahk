...
;
; Creates a Help Dialog that Shows Current, active AHK Hotkeys (and hotstrings)

;================== Hotkeys ===================
; Windows key F1  ~ Displays Hotkey Help Results ~
; Windows key Alt F1  ~ Displays Hotkey Help Settings ~
; Windows key Ctrl F1  ~ Hotkey Help Excluded Files, Hotkeys, and Hotstrings ~
; Windows key Alt Ctrl F1  ~ Displays Hotkey Help Raw Hotkeys ~
; Ctrl F  ~ Find in the Hotkey Help Window ~
...
#f1::	;{ <--  ~ Display Hotkey Help Results ~
Refresh:
