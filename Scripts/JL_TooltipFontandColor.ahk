...
;source: https://www.autohotkey.com/boards/viewtopic.php?t=4777 by lexikos

ToolTip Standard tooltip
Sleep 3000

;There are two functions to use in this script, ToolTipFont() and ToolTipColor()
;when these function are executed, tooltip commands that follow will be affected by the attributes you gave to the function

ToolTipFont("s20", "Times New Roman")
Tooltip, Times New Roman with font size 20
Sleep 3000

ToolTipFont("s20", "Comic Sans MS")
ToolTip, Comic Sans MS with font size 20
Sleep 3000

ToolTipColor("Black", "White")
Tooltip, White font Black background
Sleep 3000

ToolTipColor("Black", "Red")
Tooltip, Red font Black background
Sleep 3000
