...
:?:, btu::, but ; Not just replacing "btu", as that is a unit of heat.
    ...
    ::httpL::http:
        ...
        ::thast::that, that's
        ::theather::theater, theatre, heather
        ...
        ;================== From "endolith" on GitHub Gist =================== added 11:26AM 5/14/2021
        ::ansewr::answer
        ::at he::at the
        ::avialable::available
        ::aweosme::awesome
        ...
        ;================== Mine ===================
        ;       A goodly number came from -
        ;   https://www.infoplease.com/culture-entertainment/journalism-literature/frequently-misspelled-words

        ;================== Missing apotstrophes ===================
        ::arent::aren't
        ::hed::he'd
        ::howd::how'd
        ::hows::how's
        :c:Id::I'd
        ::i'd::I'd ; Not generally necessary because the I gets capitalized automatically
        :c:Ill::I'll
        :c:Im::I'm
        ::itll::it'll
        :c:Ive::I've
        ...
        ::repaet::repeat
        ::seperate::separate
        :*?:toin::tion ; added 12:34PM Nov 20, 2021
        ::underate::underrate
        ::wich::which
; ::u::you
...
#IfWinNotActive Visual Studio Code ahk_exe Code.exe
    ; or #ifWinNotActive Freecodecamp.org ahk_exe msedge.exe ; Trying this breaks the code
