...
;            from Juho-Lee.com
;===================================================
;       Saw on one of his youTube videos.
;       added 8:42PM Dec 14, 2021

; This script creates notepads without any frames. If you see the status bar at the bottom of the notepad and want to get rid of it, launch the notepad the normal way then click View then turn off the Status bar.

; There are hotkeys built into the script as below:
; #n to create a notepad
; #! and arrow keys to move the notepad bit by bit
; Alt & LButton to click anywhere on the notepad to move it (drag it)

; The script also has an optional function to periodically back up all open notepads by auto-saving them into a selected folder.
...
; Alt button, left-click and drag anywhere to move
~Alt & LButton::
